...
agua_serie<-ts(agua,start = c(1990,1),frequency = 12)
...
```{r}
agua_serie_ent<-ts(agua,start = c(1990,1),end = c(2019,12), frequency=12)
...
```{r}
mse2<-mod2_agua_serie_ent$SSE/length(mod1_agua_serie_ent$x)
```
